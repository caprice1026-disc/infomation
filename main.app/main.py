...
results = google_search("ED 自由診療", api_key, cse_id, num=10)
...
for i, result in enumerate(results):
    ...
    print(f"Completed processing result {i+1}/{len(results)}")
    time.sleep(5)  # Adding delay to avoid sending too many requests at once